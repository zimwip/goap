...
test-pg: ## graph repository tests against PostgreSQL (GOAP_TEST_PG_DSN)
	GOAP_TEST_PG_DSN=$${GOAP_TEST_PG_DSN:-postgres://goap:goap@localhost:5432/goap?sslmode=disable} go test ./pkg/graph/...
